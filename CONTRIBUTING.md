# Contributing to read.abares

This outlines how to propose a change to read.abares. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("adamhsparks/read.abares", fork = TRUE)`.
...
Please note that the read.abares project is released with a [Contributor
Code of
Conduct](https://adamhsparks.github.io/read.abares/CODE_OF_CONDUCT.md).
