#' Manage Locally Cached ABARES Files
#'
#' Manage cached \pkg{read.abares} files with \CRANpkg{hoardr}.
#'
#' @export
#' @name manage_cache
#'
...
#'  \item `manage_cache$list()` - returns a character vector of full path file names
...
#'  \item `manage_cache$delete_all()` - delete all files, returns nothing
#' }
#'
