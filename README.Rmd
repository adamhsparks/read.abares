...
{read.abares} facilitates downloading, caching and importing these files in your R session as a {[data.table](https://cran.r-project.org/package=data.table)} object for spreadsheet data, {[sf](https://cran.r-project.org/package=sf)} for shape file data and your choice of the class of the resulting object(s) for the NetCDF data.
...
ABARES spreadhsheet data are not always consistent in their column names or orders.
{read.abares} standardises the column names and orders for the data sets it services to help you do your work more efficiently.
...
{read.abaes} automatically repairs these geometries for you when you import the data.
