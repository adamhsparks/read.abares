...
#>   access              source                                                    
#>   <dttm>              <chr>                                                     
#> 1 2025-03-30 17:28:33 /Users/adamsparks/Library/Caches/org.R-project.R/R/read.a…
#> 
#> $axis
#> # A tibble: 84 × 3
...
#> Error in collapse(tmp, inner = FALSE, indent): R character strings are limited to 2^31-1 bytes
```
...
![Soil Thickness for Australian areas of intensive agriculture of Layer 1 (A Horizon - top-soil) (derived from soil mapping)](vigfig-plot-topsoil-depth-1.png)
